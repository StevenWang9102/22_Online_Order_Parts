...
const WorkOrderAddDialog = (props: {onDialogClose: any, isStockMonitor?: boolean}) => {
  ...
  useEffect(() => {
    ...
    getSelectOptions(urlKey.WorkOrderType).then(res => setOrderTypeOptions(res))
    getSelectOptions(urlKey.WorkOrderSource).then(res => setWorkOrderSourceOptions(res))
    getSelectOptions('', 'Product/GetAllProduct').then(res => setProductsOptions(res))
  }, [])
  ...
  const formItems: ItemElementPropsInterface[] | any = [
    ...
    {name: 'orderTypeId', label: 'Order Type', inputElement: commonFormSelect(urlKey.WorkOrderType, orderTypeOptions)},
