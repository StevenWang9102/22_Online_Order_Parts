    ...
    },
    {
      ...
      render: (rowData: any) => rowData.productInventoryInfo ? (
        <div>
          ...
          <div>
            <b>Pending&nbsp;WorkOrder&nbsp;Quantity:&nbsp;</b>{rowData.productInventoryInfo.pendingWorkOrderQuantity}
          </div>
          <div>
            <b>Pending&nbsp;Order&nbsp;Quantity:&nbsp;</b>{rowData.productInventoryInfo.pendingOrderQuantity}&nbsp;&nbsp;&nbsp;
          </div>
        </div>
      ) : null
    },
