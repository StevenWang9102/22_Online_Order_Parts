import { getJoinValueFromArray } from '../../../services/helpers'
...
export const commonFormSelect = (urlInfoKey: string, data: any, valueJoinArray?: any[], disabled?: boolean, onChangeFn?: any, valueKeyString?: any) => {
