...
import {ItipsForUserRequest} from '../../../../services/i-tips-services'
...
const ItipsForUser:React.FC<Iprops> = (props) => {
  ...
  const handleVisibleChange = (visible:boolean) => {
    setVisible(visible)
    ItipsForUserRequest(props.id).then((res:any) => {
